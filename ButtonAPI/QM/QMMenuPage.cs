...
namespace onnxware.ButtonAPI.QM
{
    public class QMMenuPage : QMMenuBase
    {
        ...
        private void Initialize(string MenuTitle, string tooltip, Sprite ButtonImage)
        {
            ...
            var wrappedMSC = MenuObject.GetComponent<VRC.UI.Pages.QM.Dashboard>().field_Protected_InterfacePublicAbstractObBoObVoStObInVoStBoUnique_0;
            UnityEngine.Object.DestroyImmediate(MenuObject.GetComponent<VRC.UI.Pages.QM.Dashboard>());
