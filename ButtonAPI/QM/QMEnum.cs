...
namespace onnxware.ButtonAPI.QM
{
    public class QMEnum : QMEnumBase
    {
        ...
        {
            RightButtonOptions.onClick.AddListener(DelegateSupport.ConvertDelegate<UnityAction>( () => 
            {
        ...
        {
            LeftButtonOptions.onClick.AddListener(DelegateSupport.ConvertDelegate<UnityAction>( () => 
            {
